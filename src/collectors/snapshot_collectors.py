...
# Runtime imports for domain models (used when return_snapshots=True)
try:
    from src.domain.models import ExpirySnapshot as _ExpirySnapshot, OptionQuote as _OptionQuote
except ImportError:  # pragma: no cover
    _ExpirySnapshot = None  # type: ignore
    _OptionQuote = None  # type: ignore
...
def run_snapshot_collectors(
    ...
    *,
    ...
    build_domain_models = EnvConfig.get_bool('G6_DOMAIN_MODELS', False)
        ...
        try:
            ...
            for expiry_rule in expiry_rules:
                try:
                    ...
                    if return_snapshots and _OptionQuote is not None:
                        try:
                    ...
                    if return_snapshots and _ExpirySnapshot is not None:
                        try:
                            snapshots.append(_ExpirySnapshot(
                                index=index_symbol,
