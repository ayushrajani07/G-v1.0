...
try:
    from src.metrics import get_metrics_singleton as _get_metrics_singleton_import
except ImportError:
    _get_metrics_singleton_import = None  # type: ignore
try:
    from src.orchestrator import facade as _facade_import
except ImportError:
    _facade_import = None  # type: ignore
try:
    from src.collector.settings import get_collector_settings as _get_collector_settings_import
except ImportError:
    _get_collector_settings_import = None  # type: ignore
...
def test_no_unexpected_deprecations(monkeypatch):
    ...
    try:
        ...
        if _get_metrics_singleton_import:
        ...
        if _get_collector_settings_import:
            _get_collector_settings_import(force_reload=True)
    finally:
