...
try:
    from src.utils.path_utils import ensure_sys_path as _ensure_sys_path_import  # type: ignore
except ImportError:
    _ensure_sys_path_import = None  # type: ignore
...
try:
    if _ensure_sys_path_import:
        _ensure_sys_path_import()
except Exception:
    try:
