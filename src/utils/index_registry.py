...
_INDEXES: dict[str, IndexMeta] = {
    # Weekly expiry DOWs per requested policy (weekly Tuesdays for NSE indices below):
    # - NIFTY: Tuesday (1)
    # - BANKNIFTY: Tuesday (1)
    # - FINNIFTY: Tuesday (1)
    # - MIDCPNIFTY: Thursday (3) [unchanged]
    # - SENSEX (BFO): Thursday (3) [unchanged]
    "NIFTY": IndexMeta("NIFTY", "Nifty 50", 50.0, "NFO", 1, 24800),
    "BANKNIFTY": IndexMeta("BANKNIFTY", "Bank Nifty", 100.0, "NFO", 1, 54000),
    ...
    "SENSEX": IndexMeta("SENSEX", "BSE Sensex", 100.0, "BFO", 3, 81000),
}
