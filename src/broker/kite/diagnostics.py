...
try:
    from src.broker.kite_provider import INDEX_MAPPING as _INDEX_MAPPING
    INDEX_MAPPING: dict[str, tuple[str, str]] = _INDEX_MAPPING
except ImportError:
    INDEX_MAPPING = {"NIFTY": ("NSE", "NIFTY 50")}  # type: ignore

try:
    from src.broker.kite import quote_cache
except ImportError:
    quote_cache = None  # type: ignore
