...
# Avoid mutable default for ContextVar (ruff B039): use None as default and initialize on access
_CTX: contextvars.ContextVar[dict[str, Any] | None] = contextvars.ContextVar("g6_log_ctx", default=None)
