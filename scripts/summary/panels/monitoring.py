...
def unified_performance_storage_panel(
    ...
    *,
    ...
    try:
        ...
        panel_logger.error("Failed to render resource metrics: %s", e, exc_info=True)
        # Add fallback row
...
def _create_storage_backup_panel(
    ...
    try:
        ...
        try:
            ...
            logging.warning("Error processing CSV files created: %s", e)
        ...
        try:
            ...
            logging.warning("Error processing CSV records count: %s", e)
        ...
        try:
            ...
            logging.warning("Error processing CSV write errors: %s", e)
        ...
        try:
            ...
            logging.warning("Error processing CSV disk usage: %s", e)
            tbl.add_row("", "Disk Usage", "[yellow]N/A[/]", "[yellow]●[/]")

    except Exception as e:
        handle_ui_error(e, component="storage_backup_panel.csv_section")
        logging.error("Error processing CSV metrics section: %s", e)
    ...
    try:
        ...
        try:
            ...
            logging.warning("Error processing InfluxDB points written: %s", e)
        ...
        try:
            ...
            logging.warning("Error processing InfluxDB write success rate: %s", e)
        ...
        try:
            ...
            logging.warning("Error processing InfluxDB connection status: %s", e)
        ...
        try:
            ...
            logging.warning("Error processing InfluxDB query time: %s", e)
            tbl.add_row("", "Query Time", "[yellow]N/A[/]", "[yellow]●[/]")

    except Exception as e:
        handle_ui_error(e, component="storage_backup_panel.influxdb_section")
        logging.error("Error processing InfluxDB metrics section: %s", e)
    ...
    try:
        ...
        try:
            ...
            logging.warning("Error processing backup files created: %s", e)
        ...
        try:
            ...
            logging.warning("Error processing last backup time: %s", e)
        ...
        try:
            ...
            logging.warning("Error processing backup size: %s", e)
            tbl.add_row("", "Backup Size", "[yellow]N/A[/]", "[yellow]●[/]")

    except Exception as e:
        handle_ui_error(e, component="storage_backup_panel.backup_section")
        logging.error("Error processing backup metrics section: %s", e)
