...
class MetricsRegistry:
    ...
    def __init__(self):
        ...
        # Initialize API call tracking counters for isolated registry tests
        # These are updated by api_call.mark_api_call
        self._api_calls = 0  # type: ignore[attr-defined]
        self._api_failures = 0  # type: ignore[attr-defined]
        self._api_latency_ema = None  # type: ignore[attr-defined]
...
except (NameError, AttributeError, TypeError, ValueError, KeyError, ImportError, IOError, OSError) as e:  # Generic error handler  # pragma: no cover
