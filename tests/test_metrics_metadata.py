...
try:
    from src.metrics import get_metrics_metadata as _get_metrics_metadata_import  # type: ignore
except ImportError:
...
def test_dump_metrics_metadata_structure():
    ...
    if _get_metrics_metadata_import:
        meta = _get_metrics_metadata_import(m)  # type: ignore[misc]
    else:
