...
# Avoid runtime import cycles while keeping type hints and static checks happy
...
def init_resource_metrics(registry: MetricsRegistry) -> None:
    ...
    core(
        ...
        Counter,
        'g6_network_bytes_transferred_total',
        'Bytes transferred over network (cumulative)'
    )
