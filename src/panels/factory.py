            ...
            try:
                ...
                if isinstance(alerts, list) and alerts:
                    ...
                    if _followups is not None:
                        try:
                            limit = EnvConfig.get_int('G6_FOLLOWUPS_PANEL_LIMIT', 20)
                        ...
                        try:
                            if _severity.enabled():
                                ...
                                try:
                                    ...
                                    try:
                                        decay_cycles = EnvConfig.get_int("G6_ADAPTIVE_ALERT_SEVERITY_DECAY_CYCLES", 0)
                                        min_streak = EnvConfig.get_int("G6_ADAPTIVE_ALERT_SEVERITY_MIN_STREAK", 1)
