...
try:
    from src.config.config_wrapper import ConfigWrapper as _ConfigWrapper_import
except ImportError:
    _ConfigWrapper_import = None  # type: ignore
...
def main() -> None:
    ...
    try:
        ...
        if _ConfigWrapper_import:
            config = _ConfigWrapper_import({})
        else:
            raise
