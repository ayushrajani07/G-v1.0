...
from src.collectors.helpers.synthetic import classify_expiry_result
...
run_persist_flow = _run_persist_flow
    ...
    *,
    ...
    try:
        ...
        if _domain_models_enabled and enriched_data:
            try:
                # OptionQuote already imported at module level
        ...
        if concise_mode:
            try:
                outcome['human_row'] = _format_concise_expiry_row_fallback(
