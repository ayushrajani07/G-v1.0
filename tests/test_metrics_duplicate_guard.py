...
try:
    from src.metrics.duplicate_guard import check_duplicates as _check_duplicates_import
except ImportError:
    _check_duplicates_import = None  # type: ignore
...
def test_duplicate_metric_detection_basic():
    ...
    if not _check_duplicates_import:
        return  # Skip if not available
    summary = _check_duplicates_import(reg)
