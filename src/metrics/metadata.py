...
def reload_group_filters(reg: Any) -> None:  # pragma: no cover - thin adapter
    # Use direct environment snapshot to respect mid-test monkeypatching
    reg._enabled_groups_raw = _os.environ.get('G6_ENABLE_METRIC_GROUPS','')
    reg._disabled_groups_raw = _os.environ.get('G6_DISABLE_METRIC_GROUPS','')
