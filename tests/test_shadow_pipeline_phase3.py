...
def test_shadow_pipeline_phase3_meta(monkeypatch):
    ...
    for _m in ['src.collectors.pipeline.shadow','src.collectors.pipeline.phases']:
        monkeypatch.delitem(sys.modules, _m, raising=False)
    ...
    monkeypatch.setitem(sys.modules, 'src.collectors.modules.coverage_eval', fake_cov)
    ...
    monkeypatch.setitem(sys.modules, 'src.collectors.modules.iv_estimation', fake_iv)
    ...
    monkeypatch.setitem(sys.modules, 'src.collectors.modules.greeks_compute', fake_g)
    ...
    monkeypatch.setitem(sys.modules, 'src.collectors.modules.persist_sim', fake_persist)
