...
try:
    from src.tools.token_providers import KiteTokenProvider as _KiteTokenProvider_import  # noqa: F401 # type: ignore[attr-defined]
except ImportError:
    _KiteTokenProvider_import = None  # type: ignore[assignment]
...
def test_kite_provider_headless_requires_request_token(monkeypatch):
    ...
    if not _KiteTokenProvider_import:
        return
    from src.tools.token_providers import get_provider
