...
_ENV = EnvConfig.get_str('G6_COLOR', 'auto').lower()
...
_STATUS_MAP = {
    'healthy': (FG_BRIGHT_GREEN, True),
    'ok': (FG_GREEN, False),
    'ready': (FG_BRIGHT_GREEN, True),
    'warn': (FG_YELLOW, True),
    'warning': (FG_YELLOW, True),
    'degraded': (FG_YELLOW, True),
    'error': (FG_BRIGHT_RED, True),
    'fail': (FG_BRIGHT_RED, True),
    'failed': (FG_BRIGHT_RED, True),
    'critical': (FG_BRIGHT_RED, True),
    'na': (FG_BRIGHT_BLACK, False),
    'unknown': (FG_MAGENTA, True),
}
