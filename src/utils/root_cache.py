...
_DetectRoot = Callable[[str], str | None]

try:
    from src.utils.symbol_root import detect_root as _detect_root_impl
    def _detect_root(s: str) -> str | None:
        return _detect_root_impl(s)
