...
def batching_enabled() -> bool:
    return EnvConfig.get_bool("G6_KITE_QUOTE_BATCH", False)


def _batch_window_ms() -> int:
    return EnvConfig.get_int("G6_KITE_QUOTE_BATCH_WINDOW_MS", 15)
...
class QuoteBatcher:
    ...
    def _perform_fetch(self, provider: Any, symbols: list[str]) -> dict[str, Any]:
        ...
        limiter = None
        if build_default_rate_limiter and EnvConfig.get_bool('G6_KITE_LIMITER', False):
